...
def preprocessor(preproc_dir, mseed_dir, stations_json, overlap=0.3, n_processor=None):
    ...
    def process(station):
        ...
        if platform.system() == 'Windows':
            print('============ Station {} has {} chunks of data.'.format(station.split("\\")[1], len(uni_list)),
                  flush=True)
        else:
            print('============ Station {} has {} chunks of data.'.format(station.split("/")[1], len(uni_list)),
                  flush=True)
        ...
        for ct, month in enumerate(uni_list):
            ...
            if len(matching) == 3:
                ...
                c3 += 1
                if platform.system() == 'Windows':
                    print('  * ' + station.split("\\")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 3 components .. sampling rate: ' + str(
                        org_samplingRate))
                else:
                    print('  * ' + station.split("/")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 3 components .. sampling rate: ' + str(
                ...
                while next_slice <= end_time:
                    ...
                    tr_name = st1[0].stats.station + '_' + st1[0].stats.network + '_' + st1[0].stats.channel[
                                                                                        :2] + '_' + str(start_time)
            ...
            if len(matching) == 1:
                ...
                if platform.system() == 'Windows':
                    print('  * ' + station.split("\\")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 1 components .. sampling rate: ' + str(
                        org_samplingRate))
                else:
                    print('  * ' + station.split("/")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 1 components .. sampling rate: ' + str(
            ...
            if len(matching) == 2:
                ...
                if platform.system() == 'Windows':
                    print('  * ' + station.split("\\")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 2 components .. sampling rate: ' + str(
                        org_samplingRate))
                else:
                    print('  * ' + station.split("/")[1] + ' (' + str(count_chuncks) + ') .. ' + month.split('T')[
                        0] + ' --> ' + month.split('__')[1].split('T')[0] + ' .. 2 components .. sampling rate: ' + str(
        ...
        try:
            ...
            repfile.write(
                f' Station {output_name} had {len(uni_list)} chuncks of data, {len(dd)} slices were written, {int(sum(slide_estimates))} were expected. Number of 1-components: {c1}, Number of 2-components: {c2}, number of 3-components: {c3}, original samplieng rate: {org_samplingRate}\n')
        except Exception:
            pass
